...
import { MapPin, Star, DollarSign, Car, Hotel, UtensilsCrossed, Cloud, ArrowLeft, Navigation, ExternalLink, Crown, Sparkles, Award, Calendar, Thermometer, Eye } from 'lucide-react';
